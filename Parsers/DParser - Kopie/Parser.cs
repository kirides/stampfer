...
namespace Peter.DParser
{
    ...
    public class Parser
    {
        ...
        {
            type();
            if (this.m_Current.StartsWith("@"))
            {
                this.m_Current = this.m_Current.Replace("@", "");
                TokenMatch tm = new TokenMatch();
                tm.Position = la.pos;
                this.m_Current += la.val;
		...
		{x,T,T,T, T,x,x,x, x,T,T,x, T,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,x, x,x,T,T, T,T,x,x, x},
		...
		{x,T,T,T, T,x,x,x, x,x,x,x, T,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,x, x,x,T,T, T,T,x,x, x},
    ...
    public class Errors
    {
        ...
        public void SynErr(int line, int col, int n)
        {
            ...
            switch (n)
            {
                ...
                case 72: s = "Ungültige Klasse"; break;
                case 73: s = "Ungültige Konstantendeklaration"; break;
                case 74: s = "Ungültige Variablendeklaration"; break;
                case 75: s = "Ungültige Typendeklaration"; break;
                case 76: s = "Ungültiger Typ"; break;
                case 77: s = "Ungültige Klasse"; break;
                case 78: s = "Ungültiger Block"; break;
                case 79: s = "Ungültiger Ausdruck"; break;
                case 80: s = "Ungültige Zuweisung"; break;
                case 81: s = "Ungültiger Operator"; break;
                case 82: s = "Ungültiger Ausdruck"; break;
